  ...
  return (
    ...
    {error && <p className="text-red-600 mt-8 text-center">{error}</p>}
      <div className="flex align-middle justify-center">
        <input
          type="text"
          className="bg-border bg-slate-700 border-slate-500 text-slate-200 placeholder-slate-400 text-md focus:border-slate-400 block w-60 p-2 focus:outline-none mobile:w-24 mobile:m"
      ...
      <div className="flex justify-center">
        {stats.isDay !== 0 ? (
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-14 h-14 text-yellow-300 mt-12 drop-shadow-sm shadow-black"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
